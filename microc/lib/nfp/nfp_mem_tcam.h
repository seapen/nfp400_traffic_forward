...
#ifdef __PTR40
typedef __mem __addr40 __align16 mem_tcam128_t *mem_tcam128_ptr40_t;
typedef __mem __addr40 __align32 mem_tcam256_t *mem_tcam256_ptr40_t;
typedef __mem __addr40 __align64 mem_tcam384_t *mem_tcam384_ptr40_t;
typedef __mem __addr40 __align64 mem_tcam512_t *mem_tcam512_ptr40_t;
#endif
...
typedef union mem_tcam_lookup8_out_t
{
    struct
    {
        unsigned int first_match            : 8;
        unsigned int reserved               : 24;

        unsigned int match_bitf;
    };
    unsigned int value[2];
} mem_tcam_lookup8_out_t;
...
typedef union mem_tcam_lookup16_out_t
{
    struct
    {
        ...
        unsigned int first_match            : 8;    /**< First matched 16 bit word index. Equal to 0xFF when no match was found */
    };
    unsigned int value;                             /**< Accessor to entire structure */
...
typedef union mem_tcam_lookup24_out_t
{
    struct
    {
        unsigned int first_match            : 8;   /* Word index of first match lookup - 0xff when not found */
        unsigned int match_high_byte        : 8;
        unsigned int match_bitf             : 8;   /* Bits are set on matching entries */
        unsigned int reserved               : 8;
    };
    unsigned int value;
} mem_tcam_lookup24_out_t;
...
/** Alias for @ref mem_tcam128_set32_word.
 *
 * @note
...
/** Alias for @ref mem_tcam128_set32_entry_value.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
...
/** Alias for @ref mem_tcam128_set32_entry_mask.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
...
/** Alias for @ref mem_tcam128_set32_entry.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
...
/** Alias for @ref mem_tcam256_set32_word.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
...
/** Alias for @ref mem_tcam256_set32_entry_value.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam256_set24_entry_value_ptr32     mem_tcam256_set32_entry_value
#ifdef __PTR40
#define mem_tcam256_set24_entry_value_ptr40     mem_tcam256_set32_entry_value_ptr40
#endif

/** Alias for @ref mem_tcam256_set32_entry_mask.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam256_set24_entry_mask_ptr32  mem_tcam256_set32_entry_mask
#ifdef __PTR40
#define mem_tcam256_set24_entry_mask_ptr40  mem_tcam256_set32_entry_mask_ptr40
#endif

/** Alias for @ref mem_tcam256_set32_entry.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam256_set24_entry_ptr32    mem_tcam256_set32_entry
#ifdef __PTR40
#define mem_tcam256_set24_entry_ptr40   mem_tcam256_set32_entry_ptr40
#endif

/** Alias for @ref mem_tcam384_set32_word.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam384_set24_word_ptr32    mem_tcam384_set32_word
#ifdef __PTR40
#define mem_tcam384_set24_word_ptr40    mem_tcam384_set32_word_ptr40
#endif

/** Alias for @ref mem_tcam384_set32_entry_value.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam384_set24_entry_value_ptr32     mem_tcam384_set32_entry_value
#ifdef __PTR40
#define mem_tcam384_set24_entry_value_ptr40     mem_tcam384_set32_entry_value_ptr40
#endif

/** Alias for @ref mem_tcam384_set32_entry_mask.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam384_set24_entry_mask_ptr32  mem_tcam384_set32_entry_mask
#ifdef __PTR40
#define mem_tcam384_set24_entry_mask_ptr40  mem_tcam384_set32_entry_mask_ptr40
#endif

/** Alias for @ref mem_tcam384_set32_entry.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam384_set24_entry_ptr32   mem_tcam384_set32_entry
#ifdef __PTR40
#define mem_tcam384_set24_entry_ptr40   mem_tcam384_set32_entry_ptr40
#endif

/** Alias for @ref mem_tcam512_set32_word.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam512_set24_word_ptr32    mem_tcam512_set32_word
#ifdef __PTR40
#define mem_tcam512_set24_word_ptr40    mem_tcam512_set32_word_ptr40
#endif

/** Alias for @ref mem_tcam512_set32_entry_value.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam512_set24_entry_value_ptr32     mem_tcam512_set32_entry_value
#ifdef __PTR40
#define mem_tcam512_set24_entry_value_ptr40     mem_tcam512_set32_entry_value_ptr40
#endif

/** Alias for @ref mem_tcam512_set32_entry_mask.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam512_set24_entry_mask_ptr32  mem_tcam512_set32_entry_mask
#ifdef __PTR40
#define mem_tcam512_set24_entry_mask_ptr40  mem_tcam512_set32_entry_mask_ptr40
#endif

/** Alias for @ref mem_tcam512_set32_entry.
 *
 * @note
 * A 24 bit word TCAM is the same as a 32 bit word TCAM.
 * The difference is seen when lookups are performed.
 ...
 * returned for the first match.
 */
#define mem_tcam512_set24_entry_ptr32   mem_tcam512_set32_entry
#ifdef __PTR40
