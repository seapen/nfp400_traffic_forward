 ...
 *
 * Same as cls_add_imm command, but also returns pre-modified
 * memory contents.
 * @see cls_add_imm_ptr32()
 *
 */
__intrinsic
 ...
 * otherwise it has to be LW aligned.
 *
 * Same as cls_sub command, but also returns pre-modified
 * memory contents.
 * @see cls_sub_ptr32()
 *
 * @note Alignment is not currently enforced.
 ...
 * otherwise it has to be LW aligned.
 *
 * Same as cls_sub64_ptr32 command, but also returns pre-modified
 * memory contents.
 * @see cls_sub64_ptr32()
 *
 * @note Alignment is not currently enforced.
 ...
 * otherwise it has to be LW aligned.
 *
 * Same as cls_sub64_ptr40 command, but also returns pre-modified
 * memory contents.
 * @see cls_sub64_ptr40()
 *
 * @note Alignment is not currently enforced.
 ...
 * @param sig_ptr       Signal to raise upon completion
 *
 * Same as cls_sub_imm command, but also returns pre-modified
 * memory contents.
 * @see cls_sub_imm_ptr32()
 *
 */
__intrinsic
 ...
 * @param sig_ptr       Signal to raise upon completion
 *
 * Same as cls_set_bits_imm command, but also returns pre-modified
 * memory contents.
 * @see cls_set_bits_imm_ptr32()
 *
 */
__intrinsic
 ...
 * @param sig_ptr       Signal to raise upon completion
 *
 * Same as cls_add_imm_sat command, but also returns pre-modified
 * memory contents.
 * @see cls_add_imm_sat_ptr32()
 */
__intrinsic
