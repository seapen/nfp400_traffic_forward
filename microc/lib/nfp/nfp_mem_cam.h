...
typedef __mem __addr40 __align16 mem_cam128_t *mem_cam128_ptr40_t;
typedef __mem __addr40 __align32 mem_cam256_t *mem_cam256_ptr40_t;
typedef __mem __addr40 __align64 mem_cam384_t *mem_cam384_ptr40_t;
typedef __mem __addr40 __align64 mem_cam512_t *mem_cam512_ptr40_t;
#endif
...
typedef union mem_cam_lookup8_out_t
{
    struct
    {
        unsigned int match_bitf_low;
        unsigned int match_bitf_high;
    };
    unsigned int value[2];
} mem_cam_lookup8_out_t;
...
typedef union mem_cam_lookup24_add_inc_out_t
{
    ...
    {
        unsigned int match_bitf             : 16;   /**< Bits are set on matching entries */
        unsigned int count                  : 8;    /**< Upper 8-bits of the matched CAM entry is returned in this field.
 ...
 * @see mem_cam128_lookup24_add_inc
 *
 */
__intrinsic
