 ...
 *    {
 *        volatile __xwrite unsigned int wr_reg[8];
 *        unsigned int                                i;
 *        SIGNAL                                      sig;
 *
 ...
 *        volatile __xwrite  unsigned int    lookup_index[4];
...
typedef union mem_lookup_dlut_large_t
{
    struct
    {
        ...
        unsigned int table_type                         : 1;    /**< 1 = large table size. 64K to 8M. */
        unsigned int start_bit_position                 : 7;    /**< Starting bit position, bit 0 to bit 127. */
    };
    unsigned int value;                                         /**< Accessor to entire descriptor structure. */
...
typedef union mem_lookup_dlut_small_recursive_t
{
    struct
    {
        ...
        MEM_LOOKUP_DLUT_SMALL_SIZE table_size           : 3;
        unsigned int mem_location                       : 1;
        MEM_LOOKUP_RESULT result                        : 1;
        unsigned int reserved_1                         : 1;
        unsigned int base_address                       : 16;
        unsigned int direct_lookup                      : 1;
        unsigned int further_lookup_required            : 1;
    };
    unsigned int value;
} mem_lookup_dlut_small_recursive_t;
...
typedef union mem_lookup_alut_t
{
    struct
    {
        ...
        unsigned int table_number               : 3;    /**< Table number 0-7 (algorithmic table location CSR)
...
typedef union mem_lookup_alut_t
{
    struct
    {
        unsigned int address_bits               : 24;
        unsigned int table_number               : 3;
        MEM_LOOKUP_ALUT_SIZE table_size         : 2;
        unsigned int lookup_type                : 1;
        unsigned int direct_lookup              : 1;
        unsigned int internal_memory            : 1;
    };
    unsigned int value;
...
typedef union mem_lookup_hash_table_t
{
    struct
    {
        ...
        unsigned int hash_command                                   : 6;
        MEM_LOOKUP_HASH_TABLE_SIZE table_size                       : 3;
        unsigned int reserved_1                                     : 1;
        unsigned int base_address                                   : 17;
        unsigned int hash_lookup                                    : 1;
        unsigned int direct_lookup                                  : 1;
        unsigned int internal_memory                                : 1;
    };
    unsigned int value;
 ...
 */
__intrinsic
mem_lookup_result_in_read_reg_t *mem_lookup(
    __xwrite void *xfer,
