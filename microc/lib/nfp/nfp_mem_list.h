...
typedef union mem_list_desc_t0
{
    struct
    {
        ...
        unsigned int q_type         : 2;    /**< Set to TYPE_0. @see TYPE_0. */
        /*
...
typedef union mem_list_desc_t1
{
    struct
    {
         ...
         */
        unsigned int tail_ptr       : 30;   /**< Word address of last(tail) buffer of the list. */
        unsigned int q_type         : 2;    /**< Set to TYPE_1. @see TYPE_1. */
...
typedef union mem_list_desc_t2
{
    struct
    {
         ...
         */
        unsigned int tail_ptr       : 30;   /**< Word address of last(tail) buffer of the list. */
        unsigned int q_type         : 2;    /**< Set to TYPE_2. @see TYPE_2. */
...
typedef union mem_list_desc_t3
{
    struct
    {
         ...
         */
        unsigned int tail_ptr       : 30;   /**< Word address of last(tail) buffer of the list. */
        unsigned int q_type         : 2;    /**< Set to TYPE_3. @see TYPE_3. */
 ...
 */
__intrinsic
void mem_list_enqueue_t2(unsigned int q_array_number, unsigned int sop, unsigned int eop, mem_list_link_in_mem_t2 *next_ptr);
