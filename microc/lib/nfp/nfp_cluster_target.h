...
typedef union cluster_target_xpb_address_format_t
{
    struct
    {
        ...
        unsigned int slave                  : 2;
        unsigned int target_island          : 6;
        unsigned int global_xpb             : 1;
...
typedef union cluster_target_signal_me_address_format_t
{
    ...
    {
        unsigned int reserved_1             : 2;
        unsigned int signal_number          : 4;
        unsigned int remote_context         : 3;
        unsigned int remote_master          : 4;
...
typedef union cluster_target_next_neighbour_write_address_format_t
{
    ...
    {
        unsigned int reserved_1                         : 2;
        unsigned int NN_register_number                 : 7;
        CLUSTER_TARGET_ADDRESS_MODE address_mode        : 1;
        unsigned int signal_number                      : 7;
        unsigned int master                             : 4;
...
*/
__intrinsic
void cluster_target_reflect_write_sig_none(
    __xwrite void *xfer,
...
*/
__intrinsic
void cluster_target_reflect_read_sig_none(
    __xread void *xfer,
    volatile cluster_target_reflect_address_format_t  *address,
    unsigned int count
);
...
*/
__intrinsic
void cluster_target_reflect_write_sig_both(
    __xwrite void *xfer,
    volatile cluster_target_reflect_address_format_t *address,
    unsigned int count,
    sync_t sync,
...
*/
__intrinsic
void cluster_target_reflect_read_sig_both(
    __xread void *xfer,
    volatile cluster_target_reflect_address_format_t *address,
    unsigned int count,
    sync_t sync,
...
*/
__intrinsic
void cluster_target_reflect_write_sig_init(
    __xwrite void *xfer,
    volatile cluster_target_reflect_address_format_t *address,
    unsigned int count,
    sync_t sync,
...
*/
__intrinsic
void cluster_target_reflect_read_sig_init(
    __xread void *xfer,
    volatile cluster_target_reflect_address_format_t *address,
    unsigned int count,
    sync_t sync,
...
*/
__intrinsic
void cluster_target_reflect_write_sig_remote(
    __xwrite void *xfer,
    volatile cluster_target_reflect_address_format_t *address,
    unsigned int count,
    sync_t sync,
...
*/
__intrinsic
void cluster_target_reflect_read_sig_remote(
    __xread void *xfer,
    volatile cluster_target_reflect_address_format_t *address,
    unsigned int count,
    sync_t sync,
...
*/
__intrinsic
void cluster_target_sig_me_ctx(
...
*/
__intrinsic
void cluster_target_next_neighbour_write(
    __xwrite void *xfer,
...
*/
__intrinsic
void cluster_target_next_neighbour_write_ind(
    __xwrite void *xfer,
    volatile cluster_target_next_neighbour_write_address_format_t *address,
    unsigned int max_nn,
    generic_ind_t ind,
