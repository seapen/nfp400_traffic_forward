 ...
 * with the cls_state_test() intrinsic.
 */
typedef enum
{
...
#ifdef __PTR40
__intrinsic
void cls_ring_journal_ind_ptr40(
    __xwrite void *data,
    volatile void __addr40 __cls *address,
    unsigned int max_nn,
    generic_ind_t ind,
 ...
 */
__intrinsic
void cls_ring_journal_ind_ptr32(
    __xwrite void *data,
    volatile void __cls *address,
    unsigned int max_nn,
    generic_ind_t ind,
...
#ifdef __PTR40
__intrinsic
void cls_ring_get_safe_ind_ptr40(
    __xread void *data,
    volatile void __addr40 __cls *address,
    unsigned int max_nn,
    generic_ind_t ind,
 ...
 */
__intrinsic
void cls_ring_get_safe_ind_ptr32(
    __xread void *data,
    volatile void __cls *address,
    unsigned int max_nn,
    generic_ind_t ind,
...
#ifdef __PTR40
__intrinsic
void cls_ring_pop_safe_ind_ptr40(
    __xread void *data,
    volatile void __addr40 __cls *address,
    unsigned int max_nn,
    generic_ind_t ind,
 ...
 */
__intrinsic
void cls_ring_pop_safe_ind_ptr32(
    __xread void *data,
    volatile void __cls *address,
    unsigned int max_nn,
    generic_ind_t ind,
